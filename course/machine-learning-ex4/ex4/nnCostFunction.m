...
%Theta1(:,2:end) means all row and cols from 2 to end to remove bias value

%backpropagation algorithm

%forward pass precalculated step 1
...
f2=f3*Theta2;
f2=(f2.*sigmoidGradient([ones(size(z2),1) z2]))(:,2:end); %addedf2(0) 
